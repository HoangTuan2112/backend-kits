package com.kits.nhom3.Eccormerce.service;
...
public class AwsS3Service {
    ...
    public String saveImageToS3(MultipartFile photo){
        try {
            ...
            String s3FileName = photo.getOriginalFilename()+random;
            ...
            return "https://" + bucketName + ".s3.ap-southeast-1.amazonaws.com/" + s3FileName;
